...
public class Validator {
    ...
    public static String getValidRoshamboInput(Scanner sc, String prompt) {
	ArrayList<String> validInputs = new ArrayList<>();
	validInputs.add("rock");
	validInputs.add("paper");
	validInputs.add("scissors");

	boolean valid = false;
	String input;
	do {
	    input = getString(sc, prompt);
	    if (validInputs.contains(input.toLowerCase())) {
		valid = true;
	    }
	} while (!valid);
	return input;
